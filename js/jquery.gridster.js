    ...
    */
    fn.on_stop_drag = function(event, ui) {
        ...
        if (this.options.draggable.stop) {
            var ui2 = ui;
            ui2.overlapped_widgets = this.overlapped_widgets
            ui2.player=this.$player[0]
          this.options.draggable.stop.call(this, event, ui2);
        }
    ...
    */
    fn.set_player = function(col, row, no_player) {
        ...
        var $overlapped_widgets = this.get_widgets_overlapped(
            this.player_grid_data);
        this.overlapped_widgets = this.get_widgets_overlapped(
            this.player_grid_data);
